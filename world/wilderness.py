...
Usage:
    ...
    @py from world import wilderness; wilderness.create_wilderness()

    Once created, it is possible to move into that wilderness map:

    @py from world import wilderness; wilderness.enter_wilderness(me)
...
Customisation example:
    ...
    @py from world import wilderness; wilderness.enter_wilderness(me, coordinates=(4, 1))
...
class WildernessMapProvider(object):
    ...
    def is_valid_coordinates(self, wilderness, coordinates):
        ...
        # Lets allow for negative X and Y values
        # if x < 0:
        #     return False
        # if y < 0:
        #     return False
